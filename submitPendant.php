...
<html>
  <head>
    ...
    <title>ACI Hoist and Crane</title>
    <style type="text/css">
      /* RESET STYLES */
          ...
          <tr>
            <td align="center" valign="top" id="bodyCell">
              ...
              <!--
						...
						-->
              <table bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0" width="1000" id="emailHeader">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                          <tr>
                            <td align="center" valign="top">
                              <!-- FLEXIBLE CONTAINER // -->
                              <table border="0" cellpadding="10" cellspacing="0" width="1000" class="flexibleContainer">
                                <tbody>
                                  <tr>
              ...
              <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="1000" id="emailBody">
                ...
                <tbody>
                  <tr>
                    <td align="center" valign="top">
                      ...
                      <!--
									...
									-->
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#457FCA" class="tableColor">
                        <tbody>
                          <tr>
                            <td align="center" valign="top">
                              <!-- FLEXIBLE CONTAINER // -->
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="1000" class="flexibleContainer">
                                <tbody>
                                  <tr>
                                    <td align="center" valign="top" width="1000" class="flexibleContainerCell">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" valign="top" class="textContent">
                                              <img src="https://acihoist.com/images/logo.png">
                                              <h2 style="text-align:center;font-weight:bold;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;line-height:135%;color:#FFF;">Custom Pendant Configurator</h2>

                                              <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;clear:both;">Thank you for using the custom pendant configurator. We will be in touch shortly!</div>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                  ...
                                  <tr>
                                    <td align="center" valign="top" width="1000" class="flexibleContainerCell">
                                      <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                        <tbody>
                                          <tr>
                                            <td align="center" valign="top" style="border-bottom: #DADADA 1px solid;">
                                                  ...
                                                  <tr>
                                                    <td valign="top" class="textContent">
                                                      <!--
																					...
																					-->
                                                      <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Your Custom Pendant</h3>
                                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Below are the details of the custom pendant order submitted:</div>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                  ...
                  <tr>
                    <td align="center" valign="top">
                      <!-- CENTERING TABLE // -->
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#fefefe">
                        <tbody>
                          <tr>
                            <td align="center" valign="top">
                              <!-- FLEXIBLE CONTAINER // -->
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td valign="top" class="textContent">
													  ...
													  <h2>Customer info:</h2>
<table id="customerInfoTable" align="center" cellpadding="3" cellspacing="0"> 
	<tr>
		<td>
 ...
 <?foreach($_POST as $key => $val) {	  
		if($key == "pendant_slot_info"){
			...
			<tr>
				<td valign="top">
					<strong><?=ucwords(strtolower(str_replace("_", " ", $key)))?></strong>: 
				</td>
				<td valign="top">
					<?=$val?>
				</td>
	...
	<br />
	<br />
	<h2>Pendant Configuration:</h2>
	<table id="pendantInfoTable" align="center" cellpadding="3" cellspacing="0"> 
		<tbody>
	<?$count=0;
	foreach($pendantInfo as $slotinfo){
		...
		<tr>
			<td colspan="2">
				<h4 style="font-style:normal; margin: 10px 0 3px 0;">Slot <?=$count?></h4>
			</td>
		</tr>
		<tr>
			<td class="slotInfo">
	...
	<?}?>
									  ...
									  <tr>
										...
										<td>
											...
											<a href="mailto:info@acihoist.com">info@acihoist.com</a><br />			
										</td>
										<td>
              ...
              <!--
							...
							that spans the width of the page.
						-->
              <table bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0" width="1000" id="emailFooter">
                                        ...
                                        <tbody>
                                          <tr>
                                            <td valign="top" bgcolor="#E1E1E1">
                                              ...
                                              <!--<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                <div>Format: Copyright © 2014 <a href="http://www.charlesmudy.com/respmail/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Respmail</span></a>. All&nbsp;rights&nbsp;reserved.</div>
                                                <div>Copyright © 2016 <a href="https://www.acihoist.com" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">ACI Hoist and Crane</span></a>.</div>
